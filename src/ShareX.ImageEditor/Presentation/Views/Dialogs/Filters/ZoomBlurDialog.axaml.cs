...
public partial class ZoomBlurDialog : UserControl, IEffectDialog
{
    public event EventHandler<EffectEventArgs>? ApplyRequested;
    public event EventHandler<EffectEventArgs>? PreviewRequested;
    public event EventHandler? CancelRequested;

    public ZoomBlurDialog()
    {
    ...
    private ZoomBlurImageEffect CreateEffect()
    {
        return new ZoomBlurImageEffect
        {
            Strength = GetValue("StrengthSlider", 35d),
            Samples = (int)Math.Round(GetValue("SamplesSlider", 24d)),
