...
namespace ShareX.Editor.Views.Dialogs
{
    public partial class BrightnessDialog : UserControl
    {
        ...
        private void RequestPreview()
        {
             ...
             PreviewRequested?.Invoke(this, new EffectEventArgs(img => ImageHelpers.ApplyBrightness(img, amount), $"Brightness: {amount:0}"));
        }
        ...
        private void OnApplyClick(object? sender, RoutedEventArgs e)
        {
            ...
            ApplyRequested?.Invoke(this, new EffectEventArgs(img => ImageHelpers.ApplyBrightness(img, amount), $"Adjusted brightness by {amount:0}"));
        }
